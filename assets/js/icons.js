/* Divine Dogs v3 — Bibliothèque d'icônes */
window.DD_ICONS = {
  paw: '<svg viewBox="0 0 32 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><ellipse cx="8" cy="10" rx="2.5" ry="3.5"/><ellipse cx="24" cy="10" rx="2.5" ry="3.5"/><ellipse cx="13" cy="5.5" rx="2.2" ry="3"/><ellipse cx="19" cy="5.5" rx="2.2" ry="3"/><path d="M16 14c-4.5 0-8 3.5-8 7.5 0 2.8 2.2 4.5 5 4.5 1.5 0 2.5-.7 3-.7s1.5.7 3 .7c2.8 0 5-1.7 5-4.5 0-4-3.5-7.5-8-7.5z"/></svg>',
  ...
  trash: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/></svg>',
  plus: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>',
  save: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z"/></svg>',
  ...
  upRight: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M7 17L17 7M7 7h10v10"/></svg>',
...
window.icon = (name, size = 24) => {
  const svg = window.DD_ICONS[name];
  if (!svg) return '';
